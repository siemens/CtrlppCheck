...
//--------------------------------------------------------------------------------
  ...
  //------------------------------------------------------------------------------
  /** Function check if the quality gate has been started by WinCC OA TestFramework
    @return true when started by WinCC OA TestFramework, false otherwise.
  */
  public static bool isStartedByTestFramework()
  {
    // this file is generated by WinCC OA Testframework, before test manager has
    // been started. Therefore we "know" it is started by the testframework.
    // see also OaTestBase::isStartedByTF()
    // yes it will be better to use origin function, but it is private ;-(
