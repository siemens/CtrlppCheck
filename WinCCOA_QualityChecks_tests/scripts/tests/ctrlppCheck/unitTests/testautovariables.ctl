...
//         LOAD_LIB_2(settings.library, "std.cfg");
    ...
    //TEST_CASE(testautovar1); There are no simple pointers to pointers in Ctrl
    //TEST_CASE(testautovar2); There are no simple pointers to pointers in Ctrl
    //TEST_CASE(testautovar3); // ticket #2925 There are no simple pointers to pointers in Ctrl
    //TEST_CASE(testautovar4); // ticket #2928 There are no simple pointers to pointers in Ctrl
    //TEST_CASE(testautovar5); // ticket #2926 There are no simple pointers to pointers in Ctrl
    //TEST_CASE(testautovar6); // ticket #2931 There are no simple pointers to pointers in Ctrl
    //TEST_CASE(testautovar7); // ticket #3066 There are no simple pointers to pointers in Ctrl
    //TEST_CASE(testautovar8); There are no simple pointers to pointers in Ctrl
    //TEST_CASE(testautovar9); There are no simple pointers to pointers in Ctrl
    ...
    //TEST_CASE(testautovar14); // ticket #4776 - assignment of function parameter, goto (Makes no sense in Ctrl)
    TEST_CASE(testautovar15); // ticket #6538
    //TEST_CASE(testautovar16); // ticket #8114 Makes no sense in Ctrl
  ...
  {
    /// @todo make the function ASSERT_THROW()
    /*
  ...
  */
  /* Deallocation makes no sense in Ctrl
  ...
  */
  /* References can't be returned in Ctrl
  ...
  */
  ...
  //Missing ASSERT_EQUALS?
  /* Lambda functions don't exist in Ctrl
